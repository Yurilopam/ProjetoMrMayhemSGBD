...
public class TelaAlterarFuncionario extends javax.swing.JInternalFrame {
    ...
    private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAlterarActionPerformed
        ...
        Funcionario funcionarioLocalAlterado;
        funcionarioLocalAlterado = funcionarioDAO.findByCtps(campoCtps.getText());
        funcionarioLocalAlterado.setNome(campoNome.getText());
        try {
            funcionarioLocalAlterado.setDataNascimento(converterStringToDate(campoDataNascimento.getText()));
        ...
        funcionarioLocalAlterado.setEstadoCivil(((Enums.EstadoCivil) campoEstadoCivil.getSelectedItem()).toString());
        funcionarioLocalAlterado.setTelefone(campoTelefone.getText());
        funcionarioLocalAlterado.setRua(campoRua.getText());
        funcionarioLocalAlterado.setNumeroRua(campoNumero.getText());
        funcionarioLocalAlterado.setBairro(campoBairro.getText());
        funcionarioLocalAlterado.setCep(campoCep.getText());
        funcionarioLocalAlterado.setTipoFuncionario(((Enums.TiposDeFuncionario) campoFuncao.getSelectedItem()).toString());
        funcionarioLocalAlterado.setSalario(campoSalario.getText());
        try {
            funcionarioLocalAlterado.setDataCadastramento(converterStringToDate(campoDataAdmissao.getText()));
        } catch (ParseException ex) {
            Logger.getLogger(TelaAlterarFuncionario.class.getName()).log(Level.SEVERE, null, ex);
        }
        funcionarioDAO.update(funcionarioLocalAlterado);
